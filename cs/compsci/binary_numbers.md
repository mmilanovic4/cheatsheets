...
- **C, JavaScript, Perl, PHP, Python:** 10101001<sub>(2)</sub> = 0b10101001

- **Bash:** 10101001<sub>(2)</sub> = 2#10101001
...
Логичко НЕ је унарна логичка операција чији је резултат 1 када је операнд 0, и обрнуто.
...
Логичко И је бинарна логичка операција чији је резултат 1 само ако су оба операнда 1, а у свим другим случајевима резултат је 0.
...
Логичко ИЛИ је бинарна логичка операција чији је резултат 1 увек када је барем један операнд 1, односно 0 само ако су оба операнда 0.
...
Логичко ЕКСИЛИ је бинарна логичка операција чији је резултат 1 само ако је један од операнада 1, а други 0, односно 0 у случају да су вредности оба операнда једнаке.
